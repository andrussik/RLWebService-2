...
namespace BLL.Services.Impl
{
    ...
    {
        public SearchService(IDalCollection dal) : base(dal)
        {
        }

        public Task<IEnumerable<Book>> SearchBooksAsync(SearchRequestDTO searchRequestDTO)
        {
            throw new NotImplementedException();
            // var b = SearchQueryBuilderBL.GetBooksQueryString(searchRequestDTO);
        }
